 ...
 *
 * Override this template by copying it to `your-theme/portfolio/portfolio-category.php`.
 *
	...
	<div class="hentry">
		...
		<div class="entry-content">
			<?php
				 ...
				 * through the`nice_portfolio_category_page` hook instead of
				 * the global context.
				 *
				 * Hooked here:
				 * @see nice_portfolio_category() - 10 (prints all published projects in the current category)
				 *
				 * Hooked in:
