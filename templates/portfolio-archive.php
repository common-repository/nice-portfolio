 ...
 *
 * Override this template by copying it to `your-theme/portfolio/portfolio-archive.php`.
 *
	...
	<div class="hentry">
		...
		<div class="entry-content">
			<?php
				 ...
				 * through the`nice_portfolio_archive_page` hook instead of the
				 * global context.
				 *
				 * @since  1.0
				 *
				 * Hooked here:
				 * @see nice_portfolio() - 10 (prints all published projects)
				 */
