...
/**
 * Class Nice_Portfolio_CreateResponder
 *
 ...
 * @since 1.0
 */
class Nice_Portfolio_CreateResponder extends Nice_Portfolio_ResponderAbstract {
	/**
	...
	protected function load_libraries() {
		nice_portfolio_autoload_libraries( apply_filters( $this->domain . '_libraries', array(), $this->data ) );
	}
