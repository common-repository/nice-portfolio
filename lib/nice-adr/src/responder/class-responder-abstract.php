...
/**
 * Class Nice_Portfolio_ResponderAbstract
 *
 ...
 * @since 1.0
 */
abstract class Nice_Portfolio_ResponderAbstract implements Nice_Portfolio_ResponderInterface {
	/**
	 * Current Nice_Portfolio_Entity instance.
	 *
	 ...
	 * @since 1.0
	 *
	 * @param Nice_Portfolio_EntityInterface $data Current Nice_Portfolio_EntityInterface instance.
	 */
	protected function set_data( Nice_Portfolio_EntityInterface $data ) {
		/**
	 ...
	 * @param Nice_Portfolio_EntityInterface $instance
	 */
	protected function set_domain( Nice_Portfolio_EntityInterface $instance ) {
		/**
		 * Set current state of data.
		 */
