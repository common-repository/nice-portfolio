 ...
 *
 * @package Nice_Portfolio_Widget_API
 * @license GPL-2.0+
 * @since   1.0
 */
 ...
 */
abstract class Nice_Portfolio_WP_Widget extends WP_Widget {
	/**
	 ...
	 * @var   string
	 */
	public $id = 'nice-portfolio-widget';
	 ...
	 *
	 * @since 1.0
	 * @var   Nice_Portfolio_Widget_Cache
	 */
	 ...
	 *
	 * @since 1.0
	 * @var   Nice_Portfolio_Widget_Normalizer
	 */
	...
	public function __construct() {
		...
		$this->refresh           = apply_filters( 'nice_portfolio_widget_refresh', $this->refresh );
		$this->normalizer        = new Nice_Portfolio_Widget_Normalizer( $this->instance_defaults );
		$this->cache             = new Nice_Portfolio_Widget_Cache( $this->id . ':' . $order, $this->refresh );
		$this->textdomain        = nice_portfolio_textdomain();
		 ...
		 */
		do_action( 'nice_portfolio_widget_loaded', $this );
	 ...
	 *
	 * @see   Nice_Portfolio_Widget::normalizer::normalize_instance()
	 *
	 * @since 1.0
	 *
	 * @param $instance
	 ...
	 *
	 * @see   Nice_Portfolio_Widget::cache::set()
	 *
	 * @since 1.0
	 *
	 ...
	 *
	 * @see   Nice_Portfolio_Widget::cache::get()
	 *
	 * @since 1.0
	 *
	 * @return null|string
	 ...
	 * Cache contents of the widget.
	 *
	 * @see    Nice_Portfolio_Widget::cache::flush_cache()
	 *
	 * @since  1.0
	 *
	 * @return null|string
	 ...
	 * @since  1.0
	 *
	 * @uses   nice_portfolio_admin_get_template_part()
	 *
	...
	function form( $instance ) {
		 ...
		 * of the template.
		 */
		nice_portfolio_admin_set_current_widget( $this );

		/**
		 * Call form template.
		 */
		nice_portfolio_admin_get_template_part( str_replace( '.php', '', $this->form_template ) );

		/**
		 * Kill current widget.
		 */
		nice_portfolio_admin_unset_current_widget();
	}
	...
	protected function print_widget() {
		 ...
		 */
		nice_portfolio_set_current_widget( $this );
		 ...
		 */
		nice_portfolio_get_template( $this->template );
		 ...
		 */
		nice_portfolio_unset_current_widget();
	}
	 ...
	 * @since 1.0
	 *
	 * @param Nice_Portfolio_WP_Widget $widget Instance of widget object.
	 */
	public static function widget_title( Nice_Portfolio_WP_Widget $widget ) {
		$title = isset( $widget->args['title'] ) ? $widget->args['title'] : '';

		$widget_title = '<h3 class="widget-title">' . $title . '</h3>';

		echo apply_filters( 'nice_portfolio_widget_title', $widget_title, $title, $widget ); // WPCS: XSS ok.
	}
}
