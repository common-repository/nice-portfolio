...
/**
 * Class Nice_Portfolio_MetaboxDisplayResponder
 *
 * This class takes charge of the Nice_Portfolio_Metabox instances
 * to be displayed through WordPress APIs.
 *
 * @since 1.1
 */
class Nice_Portfolio_MetaboxDisplayResponder extends Nice_Portfolio_DisplayResponder {
	/**
	...
	protected function set_interactions() {
		/**
		 * Print metabox when the `nice_portfolio_metabox` action is called.
		 */
		add_action( 'nice_portfolio_metabox', array( $this, 'print_metabox' ) );
	 ...
	 * @since 1.1
	 *
	 * @param Nice_Portfolio_Metabox $metabox
	 */
	public static function print_metabox( Nice_Portfolio_Metabox $metabox ) {
		 ...
		 */
		$html_handler = new Nice_Portfolio_Metabox_HTMLHandler( $metabox );
	...
	public static function print_styles() {
		...
		<style type="text/css">
			...
			#nice-metabox td .nice_portfolio_textarea { width:80%; height:100px;margin:0 0 10px 0; color:#222;padding: 5px; }
