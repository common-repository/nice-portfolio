...
/**
 * Class Nice_Portfolio_MetaboxUpdateResponder
 *
 * This class takes charge of the interaction of updated Nice_Portfolio_Metabox
 * instances with WordPress APIs.
 *
 * @since 1.1
 */
class Nice_Portfolio_MetaboxUpdateResponder extends Nice_Portfolio_UpdateResponder {
	/**
