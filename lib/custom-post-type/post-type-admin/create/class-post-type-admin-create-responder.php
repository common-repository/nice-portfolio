...
/**
 * Class Nice_Portfolio_Post_Type_AdminCreateResponder
 *
 * This class takes charge of the interaction of created Nice_Portfolio_Post_Type_Admin
 * instances with WordPress APIs.
 *
 * @since 1.1
 */
class Nice_Portfolio_Post_Type_AdminCreateResponder extends Nice_Portfolio_CreateResponder {
	/**
	 * Fire main responder functionality.
	 *
	 * @since 1.1
	 *
	 * @param Nice_Portfolio_EntityInterface $post_type_admin
	 */
	public function __invoke( Nice_Portfolio_EntityInterface $post_type_admin ) {
