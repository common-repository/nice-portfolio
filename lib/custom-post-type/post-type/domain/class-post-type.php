...
if ( ! class_exists( 'Nice_Portfolio_Post_Type_Registrations' ) ) :
/**
 ...
 * @since   1.1
 */
class Nice_Portfolio_Post_Type extends Nice_Portfolio_Entity {
	/**
	 ...
	 * @var string
	 */
	protected $textdomain = 'nice-portfolio-post-type';
}
endif;
