...
/**
 * Class Nice_Portfolio_GlancerDisplayResponder
 *
 * This class takes charge of the Nice_Portfolio_Glancer instances to be
 * displayed through WordPress APIs.
 *
 * @since 1.1
 */
class Nice_Portfolio_GlancerDisplayResponder extends Nice_Portfolio_DisplayResponder {
	/**
	 * Fire main responder functionality.
	 *
	 * @since 1.1
	 *
	 * @param Nice_Portfolio_EntityInterface $glancer Initialised glancer instance.
	 */
	public function __invoke( Nice_Portfolio_EntityInterface $glancer ) {
		global $wp_version;
	 ...
	 *
	 * @uses  Nice_Portfolio_GlancerDisplayResponder::get_single_item()
	 *
	 * @since 1.1
	 */
	 ...
	 *
	 * @uses   Nice_Portfolio_GlancerDisplayResponder::get_markup()
	 *
	 * @since  1.1
	 *
