...
/**
 * Class Nice_Portfolio_IntegrationCreateResponder
 *
 * This class takes charge of the interaction of created
 * Nice_Portfolio_Integration instances with WordPress APIs.
 *
 * @see   Nice_Portfolio_Integration
 *
 * @since 1.0
 */
class Nice_Portfolio_IntegrationCreateResponder extends Nice_Portfolio_CreateResponder {
	/**
	...
	public function load_integration() {
		...
		if ( $load && file_exists( $data->path ) ) {
			nice_portfolio_autoload( $data->path );
		}
	}
