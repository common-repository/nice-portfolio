...
/**
 * Class Nice_Portfolio_WP_Shortcode
 *
 ...
 */
abstract class Nice_Portfolio_WP_Shortcode {
	/**
	...
	protected function set_output() {
		 ...
		 */
		nice_portfolio_set_current_shortcode( $this );
		 ...
		 * Unset the shortcode.
		 */
		nice_portfolio_unset_current_shortcode();
	}
}
