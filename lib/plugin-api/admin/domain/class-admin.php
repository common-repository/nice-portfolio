...
/**
 * Class Nice_Portfolio_Admin
 *
 * Main plugin class for admin facing side of WordPress plugins.
 *
 * @since 1.0
 */
class Nice_Portfolio_Admin extends Nice_Portfolio_Entity {
	/**
	 * List of admin-side representations of custom post types.
	 *
	 * @see   Nice_Portfolio_Post_Type_Admin
	 *
	 * @since 1.0
	 * @var   array
	 */
	 ...
	 *
	 * @since 1.0
	 * @var   Nice_Portfolio_Pointer_Collection
	 */
	 ...
	 *
	 * @since 1.0
	 * @var   Nice_Portfolio_WP_Widget|null
	 */
