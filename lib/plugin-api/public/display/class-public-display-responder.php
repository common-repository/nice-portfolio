...
/**
 * Class Nice_Portfolio_PublicDisplayResponder
 *
 * This class takes charge of the Nice_Portfolio_Public instances to be
 * displayed through WordPress APIs.
 *
 * @since   1.0
 */
class Nice_Portfolio_PublicDisplayResponder extends Nice_Portfolio_DisplayResponder {
	/**
	...
	public function setup_page() {
		/**
		 * @hook nice_portfolio_setup_page
		 *
		 ...
		 * @since 1.0
		 */
		do_action( 'nice_portfolio_setup_page' );
	}
	...
	public function template_include( $template ) {
		/**
		 * @hook nice_portfolio_template_include
		 *
		 * All template modifications for this plugin should be hooked here.
		 *
		 * @since 1.0
		 */
		return apply_filters( 'nice_portfolio_template_include', $template, $this->data->get_info() );
	}
	...
	public function enqueue_styles() {
		do_action( 'nice_portfolio_plugin_enqueue_styles', $this->data->get_info() );
	}
	...
	public function enqueue_scripts() {
		do_action( 'nice_portfolio_plugin_enqueue_scripts', $this->data->get_info() );
	}
}
