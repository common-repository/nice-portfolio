...
if ( ! class_exists( 'Nice_Portfolio_Pointer_Collection' ) ) :
/**
 * Class Nice_Portfolio_Pointer_Collection
 *
 ...
 */
class Nice_Portfolio_Pointer_Collection extends Nice_Portfolio_Entity {
	/**
	 * List of Nice_Portfolio_Pointer instances.
	 *
	 * @since 1.0
	 * @var   array
	 */
