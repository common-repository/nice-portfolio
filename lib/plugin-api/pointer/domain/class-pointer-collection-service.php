...
/**
 * Class Nice_Portfolio_Pointer_CollectionService
 *
 * This class deals with typical operations over Nice_Portfolio_Pointer instances.
 *
 * @package Nice_Portfolio_Plugin_API
 * @author  NiceThemes <hello@nicethemes.com>
 * @since   1.0
 */
class Nice_Portfolio_Pointer_CollectionService extends Nice_Portfolio_Service {
	/**
	 ...
	 * @since 1.0
	 *
	 * @param Nice_Portfolio_Pointer_Collection $instance
	 * @param Nice_Portfolio_Pointer            $pointer
	 */
	public function add_pointer(
		Nice_Portfolio_Pointer_Collection $instance,
		Nice_Portfolio_Pointer $pointer
	) {
