...
/**
 * Class Nice_Portfolio_Pointer_CollectionDisplayResponder
 *
 * This class takes charge of the Nice_Portfolio_Pointer_Collection instances
 * to be displayed through WordPress APIs.
 *
 * @since   1.0
 */
class Nice_Portfolio_Pointer_CollectionDisplayResponder extends Nice_Portfolio_DisplayResponder {
	/**
	 ...
	 *
	 * @see    Nice_Portfolio_Pointer_CollectionCreateResponder::get_formatted_pointers()
	 *
	 * @since  1.0
	 *
