...
/**
 * Class Nice_Portfolio_Context_Handler
 *
...
class Nice_Portfolio_Context_Handler {
	...
	protected function get_current_context() {
		...
		if ( function_exists( 'nice_portfolio_doing_shortcode' ) && nice_portfolio_doing_shortcode() ) {
			$context = 'shortcode';
		}

		if ( is_null( $context ) && function_exists( 'nice_portfolio_doing_widget' ) && nice_portfolio_doing_widget() ) {
			$context = 'widget';
		}
