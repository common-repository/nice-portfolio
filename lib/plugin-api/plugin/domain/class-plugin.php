 ...
 * @since   1.0
 */
class Nice_Portfolio_Plugin extends Nice_Portfolio_Entity {
	/**
	 ...
	 * @var   string
	 */
	protected $settings_name = 'nice_portfolio_settings';
	 ...
	 *
	 * @since 1.0
	 * @var   Nice_Portfolio_i18n
	 */
	protected $i18n = null;

	/**
	 * List of Nice_Portfolio_Post_Type instances.
	 *
	 * @since 1.0
	 * @var   array
	 */
